...
def prepare_data(source_dir, data_dir, report_dir, input_str, label_str, ratios=[0.75, 0.15], batch_size=2,
                 feature_dim=2, images_fn=None, clobber=False, pad_base=0):
    data = {}
